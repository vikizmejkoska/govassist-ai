...
import { officerApi, requestsApi } from '@/api/requests';
                        ...
                        {request.documents.map((document) => (
                            <ListItem key={document.id} disablePadding className={styles.listItemSpacious}>
                              <ListItemText
                                  ...
                                  secondary={`${document.fileType} - ${formatDateTime(document.uploadedAt)}`}
                              />
                              <Button
                                  variant="outlined"
                                  size="small"
                                  onClick={() => void requestsApi.downloadDocument(Number(requestId), document.id, document.originalFileName)}
                              >
                                Download
                              </Button>
                            </ListItem>
